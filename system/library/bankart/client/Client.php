...
namespace Bankart\Client;

use Bankart\Client\CustomerProfile\CustomerData;
use Bankart\Client\CustomerProfile\DeleteProfileResponse;
use Bankart\Client\CustomerProfile\GetProfileResponse;
use Bankart\Client\CustomerProfile\PaymentInstrument;
use Bankart\Client\CustomerProfile\UpdateProfileResponse;
use Bankart\Client\Exception\GeneralErrorException;
use Bankart\Client\Exception\TypeException;
use Bankart\Client\Json\ErrorResponse;
use Bankart\Client\Exception\RateLimitException;
use Bankart\Client\Json\JsonParser;
use Bankart\Client\Options\OptionsResult;
use Bankart\Client\Schedule\ContinueSchedule;
use Bankart\Client\Schedule\ScheduleData;
use Bankart\Client\Exception\ClientException;
use Bankart\Client\Exception\InvalidValueException;
use Bankart\Client\Exception\TimeoutException;
use Bankart\Client\Http\CurlClient;
use Bankart\Client\Http\Response;
use Bankart\Client\Schedule\StartSchedule;
use Bankart\Client\StatusApi\StatusRequestData;
use Bankart\Client\Transaction\Base\AbstractTransaction;
use Bankart\Client\Transaction\Capture;
use Bankart\Client\Transaction\Debit;
use Bankart\Client\Transaction\Deregister;
use Bankart\Client\Transaction\Payout;
use Bankart\Client\Transaction\Preauthorize;
use Bankart\Client\Transaction\Refund;
use Bankart\Client\Transaction\Register;
use Bankart\Client\Transaction\Result;
use Bankart\Client\Transaction\VoidTransaction;
use Bankart\Client\Json\JsonGenerator;
use Bankart\Client\Xml\XmlGenerator;
use Bankart\Client\Xml\Parser;
...
class Client {
    ...
    const SCHEDULE_ACTION_SHOW = 'getSchedule'; //was showSchedule
