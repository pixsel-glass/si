...
namespace Bankart\Client\Json;

use Bankart\Client\Callback\Result as CallbackResult;
use Bankart\Client\Data\ChargebackData;
use Bankart\Client\Data\ChargebackReversalData;
use Bankart\Client\Data\Customer;
use Bankart\Client\Data\CustomerProfileData;
use Bankart\Client\Data\Result\CreditcardData as ReturnCardData;
use Bankart\Client\Data\Result\IbanData as ReturnIbanData;
use Bankart\Client\Data\Result\PhoneData as ReturnPhoneData;
use Bankart\Client\Data\Result\ResultData;
use Bankart\Client\Data\Result\ScheduleResultData;
use Bankart\Client\Data\Result\WalletData as ReturnWalletData;
use Bankart\Client\Data\RiskCheckData;
use Bankart\Client\Options\OptionsResult;
use Bankart\Client\Schedule\ScheduleResult;
use Bankart\Client\StatusApi\StatusResult;
use Bankart\Client\Transaction\Error;
use Bankart\Client\Transaction\Result;

/**
 * Class JsonParser
 *
 * @package Bankart\Client\Json
 */
class JsonParser {
