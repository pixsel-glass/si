...
class ControllerCommonColumnLeft extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($this->user->hasPermission('access', 'localisation/country_delivery')) {

				$localisation[] = array(

					'name'	   => $this->language->get('text_country_delivery'),

					'href'     => $this->url->link('localisation/country_delivery', 'user_token=' . $this->session->data['user_token'], true),
