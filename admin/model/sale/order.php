...
class ModelSaleOrder extends Model {
	public function getOrder($order_id) {
		...
		if ($order_query->num_rows) {
			...
			return array(
				...
				'pixsel_price_rate'		  => $order_query->row['pixsel_price_rate'],
	...
	public function getOrders($data = array()) {
		$sql = "SELECT o.order_id, o.payed, o.customer_id, CONCAT(o.firstname, ' ', o.lastname) AS customer, (SELECT os.name FROM " . DB_PREFIX . "order_status os WHERE os.order_status_id = o.order_status_id AND os.language_id = '" . (int)$this->config->get('config_language_id') . "') AS order_status, o.shipping_code, o.total, o.currency_code, o.currency_value, o.date_added, o.date_modified, o.order_my_sklad_box, o.order_my_sklad_btc, o.order_my_sklad_ttn, o.order_my_sklad_ttn_date, o.infakt_number FROM `" . DB_PREFIX . "order` o";
