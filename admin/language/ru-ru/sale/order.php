...
$_['text_dop_info']	             = 'Доп. информация';
$_['text_call_me']	             = 'Требуется звонок менеджера';
$_['text_not_call_me']           = 'Не требуется звонок менеджера';
$_['text_ordered_by'] 	         = 'Заказ оформил менеджер:';

$_['text_price_rate']            = 'Курс валют';
$_['text_price_rate_help']       = 'Курс валют на момент оформления';

$_['text_infakt'] 	             = 'Infakt Faktura';
$_['text_link_infakt'] 	         = 'Открыть';
$_['text_remove_infakt']         = 'Удалить фактуру?';

$_['text_title_infakt_modal']	 = 'Настройка InFakt для заказа №';
$_['text_infakt_language']		 = 'Язык';
$_['text_infakt_currency']		 = 'Валюта';
$_['text_infakt_pmethod']		 = 'Способ оплаты';
$_['text_infakt_save']			 = 'Сохранить';
$_['text_faktyre']				 = 'Требуется фактура';
$_['text_not_faktyre']			 = 'Не требуется фактура';
$_['text_privat_person']		 = 'Физ.лицо';

$_['text_without_vat']			 = 'Заказ без VAT';
...
$_['entry_payed']                = 'Заказ оплачен';
$_['entry_spayed']   		     = 'Оплачен';
$_['entry_snpayed']   		     = 'Не оплачен';
$_['text_payed']       		     = 'Оплата';
...
$_['error_orderid']	             = 'Неправильный идентификатор заказа!';
$_['error_nip']		             = 'Отсутствует Название фирмы или NIP у клиента!';
