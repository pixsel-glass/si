...
$_['tab_default']          		= 'По умолчанию';
$_['text_account']              = 'Информация о клиенте';
$_['text_password']             = 'Пароль';
$_['text_other']                = 'Другое';
$_['text_affiliate']            = 'Информация о партнере';
$_['text_payment']              = 'Информация об оплате';
...
$_['text_reward']               = 'Баллы';
$_['text_reward_add']           = 'Добавить баллы';
$_['text_ip']                   = 'IP';
$_['text_option']               = 'Варианты';
$_['text_login']                = 'Авторизироваться в магазине';
...
$_['entry_tracking']            = 'Реферальный код';
...
$_['tab_company']               = 'Компания';
$_['entry_company_vatcode']     = 'VAT код';

$_['entry_nrreg']				= 'Регистрационный номер';
$_['entry_bank']		        = 'Банк';

$_['text_create_infakt']        =  'Create an invoice';
$_['text_infakt_title']         =  'Вам нужна фактура для вашего заказа';
$_['text_infakt_help']         	=  'Если на этом этапе вы не предоставите свой идентификационный номер налогоплательщика и другие сведения о компании, вы можете не получить счет за эту покупку.';
$_['text_infakt_create']        =  'Я хочу получить фактуру';
$_['text_infakt_private']       =  'Частное лицо';
$_['entry_company_nip']			=  'NIP';

$_['text_customer_private']  	  = 'Физ. лицо';
$_['text_customer_firma']  		  = 'Фирма';
$_['text_customer_manager']  	  = 'Сотрудник Pixsel';
$_['entry_company_name']  		  = 'Название Фирмы';
$_['entry_company_nip'] 		  = 'NIP';
$_['entry_pl_company_name']  	  = 'VAT Название в базе';
$_['entry_company_region'] 		  = 'VAT Город';
$_['entry_company_address']		  = 'VAT Адрес';
$_['entry_company_zip']			  = 'VAT Почтовый индекс';
$_['entry_invoice_banks'] 		  = 'Счета';
$_['entry_payment_delay'] 		  = 'Отсрочка платежа';
$_['text_show_hide_other_fields'] = 'Показать / Скрыть дополнительные поля';
...
$_['help_affiliate']            = 'Разрешить / Запретить клиентам использовать партнерскую программу.';
$_['help_tracking']             = 'Данный код используется для отслеживания рефералов.';
...
$_['error_tracking']            = 'Необходимо ввести Реферальный код!';
$_['error_tracking_exists']     = 'Реферальный код уже используется другим партнером!';
