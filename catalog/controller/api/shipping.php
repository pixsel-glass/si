			...
			if (!$json) {
				...
				foreach ($results as $result) {
					if ($this->config->get('shipping_' . $result['code'] . '_status')) {
						...
						if ($quote) {
							if (isset($quote['easyship0'])) {
								$json['shipping_methods'][$quote['easyship0']['code']] = array(
									'title'      => strip_tags($quote['easyship0']['title']),
									'quote'      => $quote['easyship0']['quote'],
									'sort_order' => $quote['easyship0']['sort_order'],
									'error'      => $quote['easyship0']['error']
								);
							} else if (isset($quote['easyship1'])) {
								$json['shipping_methods'][$quote['easyship1']['code']] = array(
									'title'      => strip_tags($quote['easyship1']['title']),
									'quote'      => $quote['easyship1']['quote'],
									'sort_order' => $quote['easyship1']['sort_order'],
									'error'      => $quote['easyship1']['error']
								);
							} else {
								$json['shipping_methods'][$result['code']] = array(
									'title'      => strip_tags($quote['title']),
									'quote'      => $quote['quote'],
