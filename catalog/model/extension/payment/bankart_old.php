...
class ModelExtensionPaymentBankart extends Model
{
    ...
    // ВАЖЛИВО: Цей метод залишено для зворотної сумісності
    // Для нових окремих методів оплати використовуються:
    // - ModelExtensionPaymentBankartCc
    // - ModelExtensionPaymentBankartMcVisa
    // - ModelExtensionPaymentBankartFlik
