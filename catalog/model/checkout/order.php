...
class ModelCheckoutOrder extends Model {
	...
	public function getOrder($order_id) {
		...
		if ($order_query->num_rows) {
            ...
            //get country_id by country_delivery_id
            $country_delivery_query = $this->db->query("SELECT * FROM `" . DB_PREFIX . "country_delivery` WHERE country_delivery_id = '" . (int)$order_query->row['payment_country_id'] . "' limit 1");


            $country_query = $this->db->query("SELECT * FROM `" . DB_PREFIX . "country` WHERE country_id = '" . (int)$country_delivery_query->row['country_id'] . "'");
            ...
            //get country_id by country_delivery_id
            $country_delivery_query = $this->db->query("SELECT * FROM `" . DB_PREFIX . "country_delivery` WHERE country_delivery_id = '" . (int)$order_query->row['shipping_country_id'] . "' limit 1");
