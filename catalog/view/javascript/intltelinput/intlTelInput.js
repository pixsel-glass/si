  ...
  var Iti = class {
    ...
    _initRequests() {
      ...
      if (isAutoCountry && !this.selectedCountryData.iso2) {
        ...
        // this.setCountry(this.selectedCountryData.iso2);
    ...
    _updateMaxLength() {
      ...
      if (strictMode && intlTelInput.utils) {
        if (this.selectedCountryData.iso2) {
          ...
          var fullNm = '';
          for (var f = 0; f < coreNumber.length; f++) {
            fullNm += "9";
          }

          // this.telInput.mask(self.options.tel_mask);
          // console.log(this.getSelectedCountryData()['dialCode']);
          var initMask = '+' + this.getSelectedCountryData()['dialCode'] + '' + fullNm;
          if (initMask == '+') {
            var initMask = '+999999999999';
          }
          $('#' + this.telInput.id).mask(initMask);
        } else {
    ...
    _updateDialCode(newDialCodeBare) {
      ...
      let newNumber;
      if (newDialCodeBare == '' && inputVal == '') {
        this.telInput.value = '+';
      } else if (newDialCodeBare != '' && inputVal == '') {
        this.telInput.value = newDialCode;
      //} else if (newDialCodeBare != '' && inputVal != '') {
      } else {
        if (inputVal.charAt(0) === "+") {
          ...
          if (prevDialCode) {
            ...
            if (inputVal == '+') {
              ...
              if (inputVal.charAt(0) === "+") {
                newNumber = inputVal.replace("+", newDialCode);
              } else {
