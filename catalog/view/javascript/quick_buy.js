...
$(document).on('click', '#button-shipping-method', function(){
	setTimeout(function(){
		if ($('#quick-buy-script').attr('data-oc') < 4) {
				...
				var shippingMethod = $('#collapse-shipping-address input[name="code"]').val();
			}
